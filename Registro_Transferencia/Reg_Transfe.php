...
if(isset($_POST['submit'])){
        ...
        if ($count == 1) {
            ...
            $query = "INSERT INTO membresia (id_membresia, id_ci, nombre, ap_paterno,ap_materno, genero,
                    ...
                    VALUES ('','$_POST[ci]', '$_POST[nombre]', '$_POST[ap_pa]', '$_POST[ap_ma]','$gen',
                     '$_POST[tel]',
                     '$_POST[cel]', 
                     '$_POST[fecha_nac]', 
                     '$_POST[lugar]',
            ...
            $query2 = "INSERT INTO miembro_transferencia (id_transferencia, id_ci, iglesia, carta_transferencia) 
                    VALUES ('','$_POST[ci]', '$_POST[iglesia]','$car')";
...
<head>
    ...
    <link rel="stylesheet" href="Reg_Transferenci.css">
...
<?php
    ...
    <header>
        <div class="textos">
            ...
            <h2 class="subtitulo">Registro por Transferencias</h2>
        ...
        <div class="formulario" style="text-align:center;">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="derecha">
                    ...
                    <input type="date" placeholder="Fecha de Conversion" required name="fecha_con" >
                </div>
                <div class="izquierdafecha">
                    <h3>Fecha de Bautizo*</h3>
                    <input type="date" placeholder="Fecha de Bautizo" required name="fecha_bau">
                </div>
                ...
                <div class="izquierdaigle">
                    <input type="text" placeholder="Iglesia" name="iglesia">
                </div>
                <div class="derecha">

                    <p><h3>Carta de Transferencia</h3></p>
                    <select name="Carta">

...
if(isset($_POST['submit'])){
        ...
        if ($count == 1) {
            ...
            $query2 = "INSERT INTO miembro_solicitud (id_solicitud, id_ci, formulario) VALUES ('','$_POST[ci]', '$formu')";
...
<head>
    ...
    <link rel="stylesheet" href="Reg_Solicitu.css">
...
<?php
    ...
    <header>
        ...
        <div class="textos">
            ...
            <h2 class="subtitulo">Registro por Solicitud</h2>
    ...
    <div class="contenedor-form">
        ...
        <div class="formulario" style="text-align:center;">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                ...
                <!--<div class="izquierda">
                    <input type="text" placeholder="Formulario" name="">
                </div>-->
                <div class="izquierda">
